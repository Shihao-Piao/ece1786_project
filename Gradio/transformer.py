...
class SeqtoSeqTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        Args:
            ...
            num_of_heads: number of heads of multi attention heads
            num_of_encoders: number of encoders
            num_of_decoders: number of decoders
            pad_idx: pad index of source
            drop_out = dropout probability
            num_fwd_expansion: number of dense nuerons in forward expansion in encoder
        ...
        self.transformer = nn.Transformer(d_model=embedding_size, nhead=num_of_heads, num_encoder_layers=num_of_encoders,
                                          num_decoder_layers=num_of_decoders, dim_feedforward=num_fwd_expansion,
                                          dropout=drop_out,
                                          batch_first=True)
    ...
    def decoder(self, trg, encoder_out):
